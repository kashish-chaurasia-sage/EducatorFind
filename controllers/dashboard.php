		...
		<?php $this->load->view('layout/sidebar');?>
            ...
            <div class="ud-cen">
                    ...
                    <div class="ud-payment ud-pro-link">
                        <div class="pay-lhs">
                            <div class="lis-pro-badg">
                                <div>
                               <img src="<?php echo base_url('uploads/'.$this->session->userdata('id').'/'.$this->session->userdata('user_image'));?>" alt="" onerror="this.onerror=null;this.src='<?php echo base_url('assets/public/images/no-image.jpg');?>';">
                    ...
                    <div class="ud-payment ud-pro-link bus-pg">
                        <div class="pay-lhs">
                            <div class="lis-pro-badg">
                                <div>
                                    <img
                                        src="<?php echo base_url('assets/public/images/user_avtar.png');?>" alt="">
                                    <h4><?php echo $this->session->userdata('username');?></h4>
                                    <p>Member since <?php echo $this->session->userdata('usercreated');?></p>
                                </div>
                                <a href="<?php echo base_url('/profile/');?>" class="fclick" target="_blank">&nbsp;</a>
                ...
                <div class="ud-cen-s2">
                    ...
                    <a href="#" class="db-tit-btn">Add New Listing</a>
