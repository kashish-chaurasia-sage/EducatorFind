 <?php $this->load->view('layout/header');?>
    ...
    <section class=" ud">
        <div class="ud-inn">
            ...
            <div class="ud-lhs">
                <div class="ud-lhs-s1">
                    <img src="<?php echo base_url('uploads/'.$user_data->id.'/'.$user_data->edu_image);?>" alt="" onerror="this.onerror=null;this.src='<?php echo base_url('assets/public/images/no-image.jpg');?>';">
                    <h4><?php echo $this->session->userdata('username');?></h4>
                    <b>Join on <?php echo $this->session->userdata('usercreated');?></b>
                    <a class="ud-lhs-view-pro" target="_blank" href="#">My Profile</a>
					
                </div>
                <div class="ud-lhs-s2">
                    <ul>
                        <li>
                            <a href="" class="db-lact"><img src="<?php echo base_url('assets/public/images/sidebar/dbl1.png');?>" alt="" /> My Dashboard</a>
                        </li>
                       <li>
                       ...
                       <li>
                            <a href="<?php echo base_url('blog');?>" class=""><img src="<?php echo base_url('assets/public/images/sidebar/blog1.png');?>" alt=""/>Blog posts</a>
                        </li>
                        ...
                        <li>
                            <a href="" class=""><img src="<?php echo base_url('assets/public/images/sidebar/dbl9.png');?>" alt="">Payment & plan</a>
                        </li>
                        <li>
                            <a href="" class=""><img src="<?php echo base_url('assets/public/images/sidebar/dbl16.png');?>" alt=""/>Payment invoice</a>
                        </li>
                        <li>
                            <a href="" class=""><img src="<?php echo base_url('assets/public/images/sidebar/dbl19.png');?>" alt="" />Notifications</a>
                        </li>

                        <li>
                            <a href="db-setting" class=""><img src="<?php echo base_url('assets/public/images/sidebar/dbl210.png');?>" alt="" />Setting</a>
                        </li>
                  <li>
       ...
       <div class="ud-cen">
        ...
        <span class="udb-inst">Liked Listings</span>
                <div class="ud-cen-s2">
            <h2>All Liked Listings</h2>
                ...
                <tbody>
                        ...
                        <td>1</td>
                        <td><img
                                src="images/listings/26278pexels-andrea-piacquadio-3757942.jpg">The Royal Spa Center for Women <span>08, Dec 2019</span></td>
                        <td><span class="db-list-rat">4</span></td>
                        <td><a href="liked-listing-trash?likedlistinglikedlistinglikedlistinglikedlistinglikedlisting=328"><span class="db-list-edit">Remove</span></a></td>
                        <td><a href="https://bizbookdirectorytemplate.com/listing/the-royal-spa-center-for-women" class="db-list-edit" target="_blank">Preview</a></td>
                    </tr>
