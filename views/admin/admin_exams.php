    ...
    <div class="ad-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <span class="udb-inst">All Exams Details</span>
                <div class="ud-cen-s2">
                    <h2>Exams</h2>
					...
					<a href="<?php echo base_url('admin_exams/add');?>" class="db-tit-btn">Add new exams</a>
        ...
        <tbody>
            	 <?php if(!empty($edu_exams)){
							$i=1;
							foreach($edu_exams as $key =>$value){ ?>
                            <tr>
                                <td><?=$i;?></td>
                                <td>  <?=$value->edu_exams_title;?> </td>
                                <td><?=$value->edu_exams_created;?> </td>    
								<td><?=$value->edu_exams_updated;?> </td>    								
								</tr>    
							<?php $i++; } }else{?>
