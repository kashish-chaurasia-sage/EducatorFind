    ...
    <section class=" ud">
        <div class="ud-inn">
          ...
          <div class="ud-cen">
				...
				<span class="udb-inst">Edit User Profile</span>
                                <div class="ud-cen-s2 ud-pro-edit">
                    <h2>Profile Details</h2>
                       <form id="profile_update" name="profile_update" action="<?php echo base_url('profile/update_profile'); ?>" method="post" enctype="multipart/form-data">
                         <table class="responsive-table bordered">
							<tbody>
                                ...
                                <tr>
									...
									<td>
                                        <div class="form-group">
                                          <input type="text" name="mobile_number" class="form-control" value="<?= $user_data[0]->phone ? $user_data[0]->phone :'-';?>">
                                        </div>
                                    </td>
								</tr>
                                <tr>
									...
									<td>
                                        <div class="form-group">
                                          <input type="text" id="select-city" class="autocomplete form-control"
                                                 name="user_city" value="<?= $user_data[0]->city ? $user_data[0]->city :'-';?>">
                                        </div>
									 </td>
								</tr>
                                <tr>
									...
									<td>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="user_facebook" value="<?= $user_data[0]->user_facebook ? $user_data[0]->user_facebook :'-';?>">
                                        </div>
                                    </td>
								</tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="user_twitter" value=" <?= $user_data[0]->user_twitter? $user_data[0]->user_twitter :'-';?>">
                                        </div>
                                    </td>
								</tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="user_youtube" value="<?= $user_data[0]->user_youtube ? $user_data[0]->user_youtube :'-';?>">
                                        </div>
                                    </td>
								</tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                          <input type="text" class="form-control" name="user_website" value="<?= $user_data[0]->user_website ? $user_data[0]->user_website :'-';?>">
                                        </div>
                                    </td>
								</tr>
                                <tr>
