 <?php $this->load->view('layout/header');?>
    ...
    <section class=" ud">
        ...
        <span class="udb-inst">Blog posts</span>
                <div class="ud-cen-s2">
            <h2>Blog Details</h2>
                        <a href="<?php echo base_url('my-blog/create-blog');?>" class="db-tit-btn">Add new post</a>
            <table class="responsive-table bordered">
                ...
                <tbody>
                <?php if(!empty($blog)){ $i=1;
							foreach($blog as $key => $value){ 
							?>
                                                    <tr>
                                <td><?= $i;?></td>
                                <td><?= $value->blog_title;?></td>
								 <td><img src="<?= base_url('uploads/blog/'.$value->blog_user_id.'/'.$value->blog_image.''); ?>" height="30px" width="30px"></td>
                                <td>
								<a href="<?= base_url('/my-blog/edit_blog/'.$value->blog_id); ?>"><span class="db-list-edit">Edit</span> </a>
								</td>
                                <td>
								<a href="<?= base_url('/my-blog/delete_blog/'.$value->blog_id); ?>"><span class="db-list-edit">Delete</span> </a>
								</td>
                                <td>
								<a href="<?= base_url('/blog/'.$value->blog_id.'/'.$value->blog_title.''); ?>"><span class="db-list-edit">Preview</span> </a>
								</td>
